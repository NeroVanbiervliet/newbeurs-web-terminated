 ...
 * Generated at: 2015-09-01 08:53:01 UTC
...
else if(postOrigin.equals("login_form"))
{
	...
	else // login failed
	{
 	...
 	String loginStatus = (String) request.getSession().getAttribute("loginStatus");
      ...
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<script>\n");
      out.write("\t\t\t\t\t// NEED met jsp een array stockeren in javascript die dan geraadpleegd wordt bij updateInfo() functie\n");
      out.write("\t\t\t\t</script>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t<label for=\"strategy\">Script</label>\n");
      out.write("\t\t\t\t\t<select id=\"strategy\" onchange=\"updateInfo()\" name=\"strategy\">\n");
      out.write("\t\t\t\t\t");
