 ...
 * Generated at: 2015-10-16 13:02:46 UTC
...
public final class stock_005fcategory_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
else if(postOrigin.equals("login_form"))
{
	...
	else // login failed
	{
 	...
 	String loginStatus = (String) request.getSession().getAttribute("loginStatus");
      ...
      out.write("\t\t\t\t}\n");
      out.write("\t\t\t</style>\n");
      out.write("\t\t\t<title>Stock category list</title>\n");
      ...
      out.write("\t\t\t\n");
      out.write("\t\t\t<h4>\n");
      out.write("\t\t\t\tStockSelection manual\n");
      out.write("\t\t\t</h4>\n");
      out.write("\t\t\t<div>\n");
      out.write("\t\t\t\tThere are two ways to use the stock selector\n");
      out.write("\t\t\t\t<ol>\n");
      out.write("\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\tEnter a collection of tickers [ticker1,ticker2,...,tickerN]. Tickers that are not found in the database are ignored. Mind the [square] brackets!<br>\n");
      out.write("\t\t\t\t\t\tExample: [AUB.AX,EIG,AIZ] \n");
      out.write("\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\tEnter a number of restrictions {category1=value1,...,categoryN=valueN} the stocks should satisfy. Mind the {curly} brackets!<br>\n");
      out.write("\t\t\t\t\t\tExample: {exchange=BRU,cap=small}\n");
      out.write("\t\t\t\t\t</li>\n");
      out.write("\t\t\t\t</ol>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t<!-- TODO br niet netjes -->\t\n");
      out.write("\t\t\t<br>\t\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t<h4>\n");
      out.write("\t\t\t\tList of possible categories and values\n");
      out.write("\t\t\t</h4>\n");
      out.write("\t\t\t\t\t\t\n");
      out.write("\t\t\t<table>\n");
      out.write("\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t<th>values occuring in database</th>\n");
      out.write("\t\t\t\t</tr>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t");
